    ...
    >
      ...
      <div className="flex flex-row items-center justify-center gap-[62px]">
        <button
          ...
          className="cursor-pointer bg-yellow-90 hover:bg-yellow text-title2 text-brown text-stroke-white button-shadow hover:button-shadow h-[94px] w-[532px] rounded-[40px] font-[geekble]"
        >
          이름점 보기
        </button>
        <button
