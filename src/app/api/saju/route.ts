  ...
  try {
    ...
    if (url.searchParams.get("mock") === "1") {
      ...
      return new Response(
        JSON.stringify({
          result:
            "MOCK 결과: 금(金)·토(土) 이루는 관계로 보입니다. 당신의 강한 금기운이 상대방의 토를기운의 상생 구조. 전반적으로 안정적이며, 단기 변동성에는 유연한 대응이 필요합니다. 당신과 상대방의 사주를 종합해보면, 금(金)과 토(土)의 기운이 조화를 이루는 관계로 보입니다. 당신의 강한 금기운이 상대방의 토를 생조해주며, 이는 서로에게 안정감을 주는 구조입니다. 특히 상대방의 사주에 편관(偏官)이 강해 리더십이 뛰어난 반면, 당신의 비견(比肩)과 식신(食神)이 이를 부드럽게 조절해줄 수 있어요. 다만 상대방의 목(木) 기운이 다소 과할 수 있으니, 때로는 유연한 태도가 필요할 것 같습니다. 해주며, 이는 서로에게 안정감을 주는 구조입니다. 특히 상대방의 사주에 편관(偏官)이 강해 리더십이 뛰어난 반면, 당신의 비견(比肩)과 식신(食神)이 이를 부드럽게 조절해줄 수 있어요. 다만 상대방의 목(木) 기운이 다소 과할 수 있으니, 때로는 유연한 태도가 필요할 것 같습니다. 보입니다. 당신의 강한 금기운이 상대방의 토를 생조해주며, 이는 서로에게 안정감을 주는 구조입니다. 특히 상대방의 사주에 편관(偏官)이 강해 리더십이 뛰어난 반면, 당신의 비견(比肩)과 식신(食神)이 이를 부드럽게 조절해줄 수 있어요. 다만 상대방의 목(木) 기운이 다소 과할 수 있으니, 때로는 유연한 태도가 필요할 것 같습니다. 해주며, 이는 서로에게 안정감을 주는 구조입니다. ",
        }),
        {
          status: 200,
