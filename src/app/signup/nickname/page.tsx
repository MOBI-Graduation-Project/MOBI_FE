...
const SignUp = () => {
 ...
 const handleNextClick = () => {
   if (nickname.trim().length >= 2 && nickname.trim() && isAgreed && isDuplicateChecked) {
     // store에 닉네임 저장
 ...
 const isButtonEnabled = nickname.trim().length >= 2 && nickname.trim() && isAgreed && isDuplicateChecked;
